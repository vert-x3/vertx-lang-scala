...
----
import io.vertx.scala.core.CompositeFuture
CompositeFuture.all(List(f1, f2, f3))

----

While the `all` composition _waits_ until all futures are completed (or one fails), the `any` composition
_waits_ for the first completed future. `link:../../scaladoc/io/vertx/scala/core/CompositeFuture.html#any(io.vertx.core.Future,%20io.vertx.core.Future)[CompositeFuture.any]` takes several futures arguments
...
import io.vertx.scala.core.Future
import io.vertx.scala.core.CompositeFuture
var future1 = Future.future()
var future2 = Future.future()
...
`link:../dataobjects.html#AddressResolverOptions#setNdots(int)[ndots]`.
