...
You can't do much in Vert.x-land unless you can commune with a `link:../../scaladoc/io/vertx/scala/core/Vertx.html[Vertx]` object!
...
----
import io.vertx.scala.core.Vertx
var vertx = Vertx.vertx(renderDataObject-VertxOptions)
...
It's done by calling `link:../../scaladoc/io/vertx/scala/core/Vertx.html#executeBlocking(io.vertx.core.Handler,%20boolean,%20io.vertx.core.Handler)[executeBlocking]` specifying both the blocking code to execute and a
result handler to be called back asynchronous when the blocking code has been executed.

[source,scala]
----
val var someAPI = examples.CoreExamples.BlockingAPI()
vertx.executeBlocking((future: io.vertx.core.Future<java.lang.Object>) => {
  // Call some blocking API that takes a significant amount of time to return
  var result = someAPI.blockingMethod("hello")
  future.complete(result)
}, (res: io.vertx.core.AsyncResult<java.lang.Object>) => {
  println(s"The result is: ${renderAsyncResultValue}")
})
...
If you don't care about ordering you can call `link:../../scaladoc/io/vertx/scala/core/Vertx.html#executeBlocking(io.vertx.core.Handler,%20boolean,%20io.vertx.core.Handler)[executeBlocking]`
...
executor.executeBlocking((future: io.vertx.core.Future<java.lang.Object>) => {
  // Call some blocking API that takes a significant amount of time to return
  var result = someAPI.blockingMethod("hello")
  future.complete(result)
}, (res: io.vertx.core.AsyncResult<java.lang.Object>) => {
...
Coordination of multiple asynchronous results can be achieved with Vert.x `link:../../scaladoc/io/vertx/scala/core/Future.html[futures]`. It
supports concurrent composition (run several async operations in parallel) and sequential composition
(chain async operations).

=== Concurrent composition

`link:../../scaladoc/io/vertx/scala/core/CompositeFuture.html#all(io.vertx.core.Future,%20io.vertx.core.Future)[CompositeFuture.all]` takes several futures arguments (up to 6) and returns a future that is
...
CompositeFuture.all(httpServerFuture, netServerFuture).setHandler((ar: io.vertx.core.AsyncResult<io.vertx.core.CompositeFuture>) => {
...
_waits_ for the first succeeded future. `link:../../scaladoc/io/vertx/scala/core/CompositeFuture.html#any(io.vertx.core.Future,%20io.vertx.core.Future)[CompositeFuture.any]` takes several futures
...
----
import io.vertx.scala.core.CompositeFuture
CompositeFuture.any(future1, future2).setHandler((ar: io.vertx.core.AsyncResult<io.vertx.core.CompositeFuture>) => {
  if (renderAsyncResultSucceeded) {
...
`link:../../scaladoc/io/vertx/scala/core/CompositeFuture.html#join(io.vertx.core.Future,%20io.vertx.core.Future)[CompositeFuture.join]` takes several futures arguments (up to 6) and returns a future that is
...
----
import io.vertx.scala.core.CompositeFuture
CompositeFuture.join(future1, future2, future3).setHandler((ar: io.vertx.core.AsyncResult<io.vertx.core.CompositeFuture>) => {
  if (renderAsyncResultSucceeded) {
    // All succeeded
  } else {
...
While `all` and `any` are implementing concurrent composition, `link:../../scaladoc/io/vertx/scala/core/Future.html#compose(io.vertx.core.Handler,%20io.vertx.core.Future)[compose]` can be used
...
* `link:../../scaladoc/io/vertx/scala/core/Future.html#compose(java.util.function.Function)[compose]`: when the current future completes,
run the given function, that returns a future. When this returned future completes, it completes the composition.
* `link:../../scaladoc/io/vertx/scala/core/Future.html#compose(io.vertx.core.Handler,%20io.vertx.core.Future)[compose]`: when the current future
...
You can use `link:../../scaladoc/io/vertx/scala/core/Future.html#completer()[completer]` that completes a future with the operation result or
...
You can deploy a verticle using one of the `link:../../scaladoc/io/vertx/scala/core/Vertx.html#deployVerticle(io.vertx.core.Verticle)[deployVerticle]` method, specifying a verticle
...
You can also programmatically register and unregister verticle factories using `link:../../scaladoc/io/vertx/scala/core/Vertx.html#registerVerticleFactory(io.vertx.core.spi.VerticleFactory)[registerVerticleFactory]`
and `link:../../scaladoc/io/vertx/scala/core/Vertx.html#unregisterVerticleFactory(io.vertx.core.spi.VerticleFactory)[unregisterVerticleFactory]` if you wish.
...
[source,scala]
----
vertx.deployVerticle("com.mycompany.MyOrderProcessorVerticle", (res: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    println(s"Deployment id is: ${renderAsyncResultValue}")
  } else {
...
Deployments can be undeployed with `link:../../scaladoc/io/vertx/scala/core/Vertx.html#undeploy(java.lang.String)[undeploy]`.
...
[source,scala]
----
vertx.undeploy(deploymentID, (res: io.vertx.core.AsyncResult<java.lang.Void>) => {
  if (renderAsyncResultSucceeded) {
...
----
var options = renderDataObject-DeploymentOptions
options.put(isolatedClasses, List("com.mycompany.myverticle.*", "com.mycompany.somepkg.SomeClass", "org.somelibrary.*"))
...
If you are embedding Vert.x and you have finished with it, you can call `link:../../scaladoc/io/vertx/scala/core/Vertx.html#close()[close]` to close it
down.
...
To retrieve the context, use the `link:../../scaladoc/io/vertx/scala/core/Vertx.html#getOrCreateContext()[getOrCreateContext]` method:
...
`link:../../scaladoc/io/vertx/scala/core/Context.html#runOnContext(io.vertx.core.Handler)[runOnContext]`:
...
The context object also let you access verticle configuration using the `link:../../scaladoc/io/vertx/scala/core/Context.html#config()[config]`
...
To set a timer to fire once you use `link:../../scaladoc/io/vertx/scala/core/Vertx.html#setTimer(long,%20io.vertx.core.Handler)[setTimer]` method passing in the delay and a handler
...
You can also set a timer to fire periodically by using `link:../../scaladoc/io/vertx/scala/core/Vertx.html#setPeriodic(long,%20io.vertx.core.Handler)[setPeriodic]`.
...
In this case, you should consider using `link:../../scaladoc/io/vertx/scala/core/Vertx.html#setTimer(long,%20io.vertx.core.Handler)[setTimer]` instead. Once your treatment has
...
To cancel a periodic timer, call `link:../../scaladoc/io/vertx/scala/core/Vertx.html#cancelTimer(long)[cancelTimer]` specifying the timer id. For example:
...
Verticle use the Vert.x worker pool for executing blocking actions, i.e `link:../../scaladoc/io/vertx/scala/core/Context.html#executeBlocking(io.vertx.core.Handler,%20boolean,%20io.vertx.core.Handler)[executeBlocking]` or
worker verticle.
...
[source,scala]
----
vertx.deployVerticle("the-verticle", renderDataObject-DeploymentOptions)
...
For example if you have deployed a verticle which creates a `link:../../scaladoc/io/vertx/scala/core/net/NetServer.html[NetServer]` which provides
`link:../../scaladoc/io/vertx/scala/core/net/NetSocket.html[NetSocket]` instances in it's handler, then it's best to always access that socket instance
...
DNS servers can be also configured when creating a `link:../../scaladoc/io/vertx/scala/core/Vertx.html[Vertx]` instance:
