...
response.push(HttpMethod.GET, "/main.js", (ar: io.vertx.core.AsyncResult<io.vertx.core.http.HttpServerResponse>) => {
  ...
  if (renderAsyncResultSucceeded) {
    ...
    println(s"Could not push client resource ${renderAsyncResultCause}")
  }
})
...
// Write some chunks
forLoop - 
for ( i <- io.vertx.codetrans.CodeBuilder$1@609425 to io.vertx.codetrans.CodeBuilder$1@745cec2f) {
...
forLoop - 
for ( i <- io.vertx.codetrans.CodeBuilder$1@54ca7f37 to io.vertx.codetrans.CodeBuilder$1@576f51b2) {
  data.appendByte(i)
}
