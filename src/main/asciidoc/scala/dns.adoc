...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup("vertx.io", (ar: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    println(renderAsyncResultValue)
  } else {
    println(s"Failed to resolve entry${renderAsyncResultCause}")
  }
})
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup4("vertx.io", (ar: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    println(renderAsyncResultValue)
  } else {
    println(s"Failed to resolve entry${renderAsyncResultCause}")
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.lookup6("vertx.io", (ar: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    println(renderAsyncResultValue)
  } else {
    println(s"Failed to resolve entry${renderAsyncResultCause}")
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveA("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<java.lang.String>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
    println(s"Failed to resolve entry${renderAsyncResultCause}")
  }
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveAAAA("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<java.lang.String>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveCNAME("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<java.lang.String>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveMX("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<io.vertx.core.dns.MxRecord>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveTXT("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<java.lang.String>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveNS("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<java.lang.String>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolveSRV("vertx.io", (ar: io.vertx.core.AsyncResult<java.util.List<io.vertx.core.dns.SrvRecord>>) => {
  if (renderAsyncResultSucceeded) {
    var records = renderAsyncResultValue
    enhancedForLoop
  } else {
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.resolvePTR("1.0.0.10.in-addr.arpa", (ar: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    var record = renderAsyncResultValue
    println(record)
  } else {
    println(s"Failed to resolve entry${renderAsyncResultCause}")
  }
...
----
var client = vertx.createDnsClient(53, "10.0.0.1")
client.reverseLookup("10.0.0.1", (ar: io.vertx.core.AsyncResult<java.lang.String>) => {
  if (renderAsyncResultSucceeded) {
    var record = renderAsyncResultValue
    println(record)
  } else {
