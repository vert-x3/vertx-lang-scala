...
You do this by defining a `link:scaladocs/io/vertx/scala/core/eventbus/MessageCodec.html[codec]` for the objects you want to send.
...
eventBus.send("news.uk.sport", "Yay! Someone kicked a ball across a patch of grass") { ar =>
  if (ar.isSuccess) {
    println("Received reply: " + ar.get.body)
  }
}
...
Vertx.clusteredVertx(options,  res =>
  if (res.isSuccess) {
    ...
    println("Failed: " + res.asInstanceOf[Failure].exception)
  }
)

----

You should also make sure you have a `link:scaladocs/io/vertx/scala/core/spi/cluster/ClusterManager.html[ClusterManager]` implementation on your classpath,
