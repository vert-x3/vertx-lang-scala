...
image:https://github.com/vert-x3/vertx-lang-scala/workflows/CI/badge.svg?branch=master["Build Status",link="https://github.com/vert-x3/vertx-lang-scala/actions?query=workflow%3ACI"]
