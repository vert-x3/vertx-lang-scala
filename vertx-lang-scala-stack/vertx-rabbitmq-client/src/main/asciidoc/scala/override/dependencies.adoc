...
----
libraryDependencies += "io.vertx" %% "vertx-rabbitmq-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-rabbitmq-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-rabbitmq-client-scala_2.13:4.0.0-SNAPSHOT"
----