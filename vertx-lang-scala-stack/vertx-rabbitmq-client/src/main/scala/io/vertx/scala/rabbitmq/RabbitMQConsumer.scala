...
/**
  ...
  */
class RabbitMQConsumer(private val _asJava: Object)
    extends  ReadStream[RabbitMQMessage]  {
  ...
  /**
    ...
    */
  override def exceptionHandler(exceptionHandler: Handler[Throwable]): RabbitMQConsumer = {
  ...
  /**
    ...
    * @return a reference to this, so the API can be used fluently
    */
  override def handler(messageArrived: Handler[RabbitMQMessage]): RabbitMQConsumer = {
  ...
  /**
    ...
    * @return a reference to this, so the API can be used fluently
    */
  override def pause(): RabbitMQConsumer = {
  ...
  /**
    ...
    * @return a reference to this, so the API can be used fluently
    */
  override def resume(): RabbitMQConsumer = {
  ...
  /**
    ...
    * @return a reference to this, so the API can be used fluently
    */
  override def endHandler(endHandler: Handler[Unit]): RabbitMQConsumer = {
