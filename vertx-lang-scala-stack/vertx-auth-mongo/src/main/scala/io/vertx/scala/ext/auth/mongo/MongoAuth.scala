...
class MongoAuth(private val _asJava: Object) extends AuthProvider (_asJava) {
   ...
   * be saved as JsonArray   * @param fieldName the name of the field to be used
   * @return the current instance itself for fluent calls
   */
   ...
   * Permissions are expected to be saved as JsonArray   * @param fieldName the name of the field to be used
   * @return the current instance itself for fluent calls
   */
   ...
   * [[io.vertx.scala.ext.auth.AuthProvider#authenticate]]. Defaults to [[io.vertx.scala.ext.auth.mongo.MongoAuth]]   * @param fieldName the name of the field to be used
   * @return the current instance itself for fluent calls
   */
   ...
   * set to    * @param fieldName the name of the field to be used
   * @return the current instance itself for fluent calls
   */
   ...
   * be saved as JsonArray   * @return the roleField
   */
   ...
   * Permissions are expected to be saved as JsonArray   * @return the permissionField
   */
   ...
   * [[io.vertx.scala.ext.auth.AuthProvider#authenticate]]. Defaults to [[io.vertx.scala.ext.auth.mongo.MongoAuth]]   * @return the usernameCredentialField
   */
   ...
   * [[io.vertx.scala.ext.auth.AuthProvider#authenticate]]. Defaults to [[io.vertx.scala.ext.auth.mongo.MongoAuth]]   * @return the passwordCredentialField
   */
...
object MongoAuth {
   ...
   * </pre>   * @param mongoClient an instance of MongoClient to be used for data storage and retrival
