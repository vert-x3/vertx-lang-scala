...
class HashStrategy(private val _asJava: Object) {
   ...
   * depending on the defined [[io.vertx.ext.auth.mongo.HashSaltStyle]]   * @param user the user to get the salt for. This paramter is needed, if the HashSaltStyle#COLUMN is declared to be used
