...
----
libraryDependencies += "io.vertx" %% "vertx-auth-mongo" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-mongo-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-mongo-scala_2.13:4.0.0-SNAPSHOT"
----