...
To create an instance of the provider you use `link:../../scaladoc/io/vertx/scala/ext/auth/shiro/ShiroAuth.html[ShiroAuth]`. You specify the type of
...
The default role prefix is `role:`. You can change this with `link:../../scaladoc/io/vertx/scala/ext/auth/shiro/ShiroAuth.html#setRolePrefix(java.lang.String)[setRolePrefix]`.
...
with `link:../../scaladoc/io/vertx/scala/ext/auth/shiro/ShiroAuth.html#setRolePrefix(java.lang.String)[setRolePrefix]`.
