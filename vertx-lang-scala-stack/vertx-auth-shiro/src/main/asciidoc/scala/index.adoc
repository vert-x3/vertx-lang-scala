...
<dependency>
  ...
  <artifactId>vertx-auth-shiro-scala_2.12</artifactId>
...
----
compile 'io.vertx:vertx-auth-shiro-scala_2.12:3.5.0-SNAPSHOT'
----
...
user.isAuthorisedFuture("newsletter:edit:13").onComplete{
  case Success(result) => {
