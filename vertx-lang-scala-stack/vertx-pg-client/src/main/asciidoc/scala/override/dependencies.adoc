...
----
libraryDependencies += "io.vertx" %% "vertx-pg-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-pg-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-pg-client-scala_2.13:4.0.0-SNAPSHOT"
----