...
object ShopifyAuth {
  ...
  def create(vertx: Vertx,clientId: String,clientSecret: String,shop: String): OAuth2Auth = {
    OAuth2Auth(JShopifyAuth.create(vertx.asJava.asInstanceOf[JVertx], clientId.asInstanceOf[java.lang.String], clientSecret.asInstanceOf[java.lang.String], shop.asInstanceOf[java.lang.String]))//2 create
  }
  ...
  def create(vertx: Vertx,clientId: String,clientSecret: String,shop: String,httpClientOptions: HttpClientOptions): OAuth2Auth = {
    OAuth2Auth(JShopifyAuth.create(vertx.asJava.asInstanceOf[JVertx], clientId.asInstanceOf[java.lang.String], clientSecret.asInstanceOf[java.lang.String], shop.asInstanceOf[java.lang.String], httpClientOptions.asJava))//2 create
  }
