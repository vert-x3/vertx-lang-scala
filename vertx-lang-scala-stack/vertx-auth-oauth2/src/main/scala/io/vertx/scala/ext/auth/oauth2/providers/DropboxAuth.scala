...
import io.vertx.ext.auth.oauth2.providers.{DropboxAuth => JDropboxAuth}
...
class DropboxAuth(private val _asJava: Object) {
  def asJava = _asJava
...
object DropboxAuth {
  ...
  def create(vertx: Vertx,clientId: String,clientSecret: String): OAuth2Auth = {
    OAuth2Auth(JDropboxAuth.create(vertx.asJava.asInstanceOf[JVertx], clientId.asInstanceOf[java.lang.String], clientSecret.asInstanceOf[java.lang.String]))//2 create
  }
  ...
  def create(vertx: Vertx,clientId: String,clientSecret: String,httpClientOptions: HttpClientOptions): OAuth2Auth = {
    OAuth2Auth(JDropboxAuth.create(vertx.asJava.asInstanceOf[JVertx], clientId.asInstanceOf[java.lang.String], clientSecret.asInstanceOf[java.lang.String], httpClientOptions.asJava))//2 create
  }
