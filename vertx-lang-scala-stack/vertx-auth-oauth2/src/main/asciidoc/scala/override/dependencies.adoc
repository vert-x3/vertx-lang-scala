...
----
libraryDependencies += "io.vertx" %% "vertx-auth-oauth2" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-oauth2-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-oauth2-scala_2.13:4.0.0-SNAPSHOT"
----