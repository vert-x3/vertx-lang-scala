...
----
libraryDependencies += "io.vertx" %% "vertx-consul-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-consul-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-consul-client-scala_2.13:4.0.0-SNAPSHOT"
----