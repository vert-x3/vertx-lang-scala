...
----
libraryDependencies += "io.vertx" %% "vertx-proton" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-proton-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-proton-scala_2.13:4.0.0-SNAPSHOT"
----