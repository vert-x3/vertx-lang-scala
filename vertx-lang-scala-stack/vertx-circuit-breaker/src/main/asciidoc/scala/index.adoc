...
breaker.execute((future: io.vertx.scala.core.Promise<java.lang.Object>) => {
...
breaker.execute((future: io.vertx.scala.core.Promise<java.lang.String>) => {
  vertx.createHttpClient().getNowFuture(8080, "localhost", "/").onComplete{
    case Success(result) => {
      var response = result
...
breaker.executeWithFallback((future: io.vertx.scala.core.Promise<java.lang.String>) => {
  vertx.createHttpClient().getNowFuture(8080, "localhost", "/").onComplete{
    case Success(result) => {
      var response = result
      if (response.statusCode() != 200) {
