...
----
libraryDependencies += "io.vertx" %% "vertx-circuit-breaker" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-circuit-breaker-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-circuit-breaker-scala_2.13:4.0.0-SNAPSHOT"
----