...
----
libraryDependencies += "io.vertx" %% "vertx-bridge-common" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-bridge-common-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-bridge-common-scala_2.13:4.0.0-SNAPSHOT"
----