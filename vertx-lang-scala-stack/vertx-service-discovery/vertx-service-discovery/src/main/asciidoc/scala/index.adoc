...
`link:../../scaladocs/io/vertx/scala/redis/client/Redis.html[Redis]` (the configuration of the client is computed from the location, metadata and
consumer configuration).
...
The client of a Redis data source service is a `link:../../scaladocs/io/vertx/scala/redis/client/Redis.html[Redis]`.
...
As stated in the previous section, how to access a data source depends on the data source itself. To build the
`link:../../scaladocs/io/vertx/scala/redis/client/Redis.html[Redis]`, you can merge configuration: the record location, the metadata and a json object provided by
the consumer:
