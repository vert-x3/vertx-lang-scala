...
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceDiscovery.html#getReference()[getReference]` or released with
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceDiscovery.html#getRecords(io.vertx.core.json.JsonObject)[getRecords]`.
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceDiscovery.html#getRecords(java.util.function.Function,%20boolean)[getRecords]`
.
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceReference.html#getAs()[getAs]`. The parameter is the type of
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/types/HttpEndpoint.html#createRecord(java.lang.String,%20java.lang.String,%20int,%20java.lang.String)[HttpEndpoint.createRecord]`.
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/types/HttpEndpoint.html#getClient(io.vertx.servicediscovery.ServiceDiscovery,%20io.vertx.core.json.JsonObject)[HttpEndpoint.getClient]`
...
HttpEndpoint.getClient(discovery, new io.vertx.core.json.JsonObject().put("name", "some-http-service"), {
  case Success(result) => {
    ...
    client.getNowFuture("/api/persons").onComplete{
      case Success(result) => println("Success")
      case Failure(cause) => println("Failure")
    }
  }
...
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceDiscovery.html#releaseServiceObject(io.vertx.servicediscovery.ServiceDiscovery)[ServiceDiscovery.releaseServiceObject]`,
...
register it using
`link:../../scaladocs/io/vertx/scala/servicediscovery/ServiceDiscovery.html#registerServiceImporter(io.vertx.servicediscovery.spi.ServiceImporter)[registerServiceImporter]`.

The second parameter can provide an optional configuration for the bridge.

When the bridge is registered the `link:../../scaladocs/io/vertx/scala/servicediscovery/spi/ServiceImporter.html#start(io.vertx.core.Vertx,%20io.vertx.servicediscovery.spi.ServicePublisher,%20io.vertx.core.json.JsonObject)[start]` method is called.
It lets you configure the bridge. When the bridge is configured, ready and has imported / exported the initial services, it must complete the given `link:../../scaladocs/io/vertx/scala/core/Future.html[Future]`.
If the bridge starts method is blocking, it must use an `link:../../scaladocs/io/vertx/scala/core/Vertx.html#executeBlocking(io.vertx.core.Handler,%20boolean)[executeBlocking]` construct, and complete the given future object.

When the service discovery is stopped, the bridge is stopped.
The `link:../../scaladocs/io/vertx/scala/servicediscovery/spi/ServiceImporter.html#close()[close]` method is called that provides the opportunity to cleanup resources, removed imported / exported services...
This method must complete the given `link:../../scaladocs/io/vertx/scala/core/Future.html[Future]` to notify the caller of the completion.
