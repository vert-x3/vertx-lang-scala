...
class ServiceDiscovery(private val _asJava: Object) {
  ...
  /**
   * Gets a service reference from the given record.   * @param record the chosen record see <a href="../../../../../../cheatsheet/Record.html">Record</a>
  ...
  /**
   * Gets a service reference from the given record, the reference is configured with the given json object.   * @param record the chosen record see <a href="../../../../../../cheatsheet/Record.html">Record</a>
  ...
  /**
   * Releases the service reference.   * @param reference the reference to release, must not be `null`
   ...
   * 
   * This method returns the first matching record.   * @param filter the filter.
   ...
   * 
   * This method only looks for records with a `UP` status.   * @param filter the filter, must not be `null`. To return all records, use a function accepting all records
   ...
   * status, if the `includeOutOfService` parameter is set to `true`.   * @param filter the filter, must not be `null`. To return all records, use a function accepting all records
   ...
   * records.   * @param filter the filter - see #getRecord(JsonObject, Handler)
  ...
  /**
   * Updates the given record. The record must has been published, and has it's registration id set.   * @param record the updated record see <a href="../../../../../../cheatsheet/Record.html">Record</a>
  ...
  */
  def getRecordFuture (filter: io.vertx.core.json.JsonObject): scala.concurrent.Future[scala.Option[Record]] = {
    //TODO: https://github.com/vert-x3/vertx-codegen/issues/111
    val promiseAndHandler = handlerForAsyncResultWithConversion[JRecord, scala.Option[Record]](x => scala.Option(x).map(Record(_)))
  ...
  * Like [[getRecord]] but returns a [[scala.concurrent.Future]] instead of taking an AsyncResultHandler.
  */
  def getRecordFuture (filter: Record => Boolean): scala.concurrent.Future[scala.Option[Record]] = {
    //TODO: https://github.com/vert-x3/vertx-codegen/issues/111
    val promiseAndHandler = handlerForAsyncResultWithConversion[JRecord, scala.Option[Record]](x => scala.Option(x).map(Record(_)))
  ...
  * Like [[getRecord]] but returns a [[scala.concurrent.Future]] instead of taking an AsyncResultHandler.
  */
  def getRecordFuture (filter: Record => Boolean, includeOutOfService: Boolean): scala.concurrent.Future[scala.Option[Record]] = {
    //TODO: https://github.com/vert-x3/vertx-codegen/issues/111
    val promiseAndHandler = handlerForAsyncResultWithConversion[JRecord, scala.Option[Record]](x => scala.Option(x).map(Record(_)))
...
object ServiceDiscovery {
  ...
  /**
   * Creates a new instance of [[io.vertx.scala.servicediscovery.ServiceDiscovery]] using the default configuration.   * @param vertx the vert.x instance
   ...
   * It searches for the reference associated with the given object and release it.   * @param discovery the service discovery
