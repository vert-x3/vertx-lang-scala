...
`link:../../scaladoc/io/vertx/scala/servicediscovery/ServiceReference.html#getAs(java.lang.Class)[getAs]`. The parameter is the type of
object you expect to get. If you are using Java, you can use
`link:../../scaladoc/io/vertx/scala/servicediscovery/ServiceReference.html#get()[get]`. However in the other language you must pass the expected
type.
...
* `link:../../scaladoc/io/vertx/scala/servicediscovery/types/RedisDataSource.html[RedisDataSource]` - for Redis data sources, the service object is a
`link:../../scaladoc/io/vertx/scala/redis/RedisClient.html[RedisClient]` (the configuration of the client is computed from the location, metadata and
consumer configuration).
* `link:../../scaladoc/io/vertx/scala/servicediscovery/types/MongoDataSource.html[MongoDataSource]` - for Mongo data sources, the service object is a
`link:../../scaladoc/io/vertx/scala/ext/mongo/MongoClient.html[MongoClient]` (the configuration of the client is computed from the location, metadata and
consumer configuration).
...
Since Vert.x 3.4.0, another client has been provided. This higher-level client, named `link:../../scaladoc/io/vertx/scala/ext/web/client/WebClient.html[WebClient]`
tends to be easier to use. You can retrieve a `link:../../scaladoc/io/vertx/scala/ext/web/client/WebClient.html[WebClient]` instances using:
...
`link:../../scaladoc/io/vertx/scala/servicediscovery/types/EventBusService.html[EventBusService]` interface that combines the two operations in one call.
...
The client of a Mongo data source service is a `link:../../scaladoc/io/vertx/scala/ext/mongo/MongoClient.html[MongoClient]`.

==== Publishing a Mongo service

Publishing a Mongo data source is a 2-step process:

1. create a record, using `link:../../scaladoc/io/vertx/scala/servicediscovery/types/MongoDataSource.html[MongoDataSource]`
2. publish the record
...
import scala.util.Failure
import scala.util.Success
import io.vertx.scala.servicediscovery.types.MongoDataSource
...
As stated in the previous section, how to access a data source depends on the data source itself. To build the
`link:../../scaladoc/io/vertx/scala/ext/mongo/MongoClient.html[MongoClient]`, you can merge configuration: the record location, the metadata and a json object
...
You can also use the `link:../../scaladoc/io/vertx/scala/servicediscovery/types/MongoDataSource.html[MongoDataSource]` class to the lookup and retrieval in one call:
