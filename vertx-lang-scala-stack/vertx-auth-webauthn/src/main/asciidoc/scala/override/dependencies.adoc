...
----
libraryDependencies += "io.vertx" %% "vertx-auth-webauthn" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-webauthn-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-webauthn-scala_2.13:4.0.0-SNAPSHOT"
----