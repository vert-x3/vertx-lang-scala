...
----
libraryDependencies += "io.vertx" %% "vertx-auth-sql" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-sql-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-sql-scala_2.13:4.0.0-SNAPSHOT"
----