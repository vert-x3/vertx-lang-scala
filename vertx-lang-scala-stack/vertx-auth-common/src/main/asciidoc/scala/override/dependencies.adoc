...
----
libraryDependencies += "io.vertx" %% "vertx-auth-common" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-common-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-common-scala_2.13:4.0.0-SNAPSHOT"
----