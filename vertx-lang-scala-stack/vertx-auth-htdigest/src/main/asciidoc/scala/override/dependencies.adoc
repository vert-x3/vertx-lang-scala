...
----
libraryDependencies += "io.vertx" %% "vertx-auth-htdigest" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-htdigest-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-htdigest-scala_2.13:4.0.0-SNAPSHOT"
----