...
We provide an implementation of `link:../../scaladoc/io/vertx/scala/ext/auth/AuthProvider.html[AuthProvider]` which uses the .digest file format
...
Once you've got one of these you can create a `link:../../scaladoc/io/vertx/scala/ext/auth/htdigest/HtdigestAuth.html[HtdigestAuth]` instance as follows:
...
Once you've got your instance you can authenticate with it just like any `link:../../scaladoc/io/vertx/scala/ext/auth/AuthProvider.html[AuthProvider]`.
