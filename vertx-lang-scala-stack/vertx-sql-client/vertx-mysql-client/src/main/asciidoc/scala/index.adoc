...
Then set the path to the domain socket in `link:../dataobjects.html#MySQLConnectOptions#setHost()[MySQLConnectOptions#setHost]`:
...
var client2 = MySQLPool.pool(vertx, connectOptions, poolOptions)
