...
----
libraryDependencies += "io.vertx" %% "vertx-sql-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-sql-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-sql-client-scala_2.13:4.0.0-SNAPSHOT"
----