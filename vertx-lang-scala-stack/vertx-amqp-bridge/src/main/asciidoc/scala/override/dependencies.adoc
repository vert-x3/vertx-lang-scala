...
----
libraryDependencies += "io.vertx" %% "vertx-amqp-bridge" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-amqp-bridge-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-amqp-bridge-scala_2.13:4.0.0-SNAPSHOT"
----