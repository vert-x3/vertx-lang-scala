...
----
dependencies {
  compile 'io.vertx:vertx-web-scala_2.12:3.4.2-SNAPSHOT'
}
----
...
to `link:../../scaladocs/io/vertx/scala/ext/web/Router.html#accept(io.vertx.core.http.HttpServerRequest)[accept]`.
...
of `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html[RoutingContext]`.
...
You set a blocking handler on a route with `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#blockingHandler(io.vertx.core.Handler)[blockingHandler]`.
Here's an example:
...
false using `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#blockingHandler(io.vertx.core.Handler,%20boolean)[blockingHandler]`.
...
If you want a route to only match for a specific HTTP method you can use `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#method(io.vertx.core.http.HttpMethod)[method]`
...
If you want to specify a route will match for more than HTTP method you can call `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#method(io.vertx.core.http.HttpMethod)[method]`
multiple times:
...
If you want to override the default ordering for routes, you can do so using `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#order(int)[order]`,
...
You can specify that a route will match against matching request MIME types using `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#consumes(java.lang.String)[consumes]`.

In this case, the request will contain a `content-type` header specifying the MIME type of the request body.
This will be matched against the value specified in `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#consumes(java.lang.String)[consumes]`.
...
By using `link:../../scaladocs/io/vertx/scala/ext/web/Route.html#produces(java.lang.String)[produces]` you define which MIME type(s) the route produces, e.g. the
...
You can use the `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#put(java.lang.String,%20java.lang.Object)[put]` to put any object, and
`link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#get(java.lang.String)[get]` to retrieve any object from the context data.
...
`link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#fail(int)[fail]` specifying an HTTP status code to deliberately signal a failure.
...
To limit the size of a request body, create the body handler then use `link:../../scaladocs/io/vertx/scala/ext/web/handler/BodyHandler.html#setBodyLimit(long)[setBodyLimit]`
...
you can use disable it with `link:../../scaladocs/io/vertx/scala/ext/web/handler/BodyHandler.html#setMergeFormAttributes(boolean)[setMergeFormAttributes]`.
...
Vert.x-Web has cookies support using the `link:../../scaladocs/io/vertx/scala/ext/web/handler/CookieHandler.html[CookieHandler]`.
...
You use `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#getCookie(java.lang.String)[getCookie]` to retrieve
a cookie by name, or use `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#cookies()[cookies]` to retrieve the entire set.

To remove a cookie, use `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#removeCookie(java.lang.String)[removeCookie]`.

To add a cookie use `link:../../scaladocs/io/vertx/scala/ext/web/RoutingContext.html#addCookie(io.vertx.ext.web.Cookie)[addCookie]`.
...
Cookies are described by instances of `link:../../scaladocs/io/vertx/scala/ext/web/Cookie.html[Cookie]`. This allows you to retrieve the name,
...
`link:../../scaladocs/io/vertx/scala/ext/web/sstore/LocalSessionStore.html#create(io.vertx.core.Vertx,%20java.lang.String,%20long)[LocalSessionStore.create]`.

Here are some examples of creating a `link:../../scaladocs/io/vertx/scala/ext/web/sstore/LocalSessionStore.html[LocalSessionStore]`
...
Here are some examples of creating a `link:../../scaladocs/io/vertx/scala/ext/web/sstore/ClusteredSessionStore.html[ClusteredSessionStore]`
...
You'll also need to include a `link:../../scaladocs/io/vertx/scala/ext/web/handler/CookieHandler.html[CookieHandler]` as the session handler uses cookies to
...
You put data into the session with `link:../../scaladocs/io/vertx/scala/ext/web/Session.html#put(java.lang.String,%20java.lang.Object)[put]`,
you get data from the session with `link:../../scaladocs/io/vertx/scala/ext/web/Session.html#get(java.lang.String)[get]`, and you remove
data from the session with `link:../../scaladocs/io/vertx/scala/ext/web/Session.html#remove(java.lang.String)[remove]`.
...
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setMaxAgeSeconds(long)[setMaxAgeSeconds]` if required.
...
If handling of cache headers is not required, it can be disabled with `link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setCachingEnabled(boolean)[setCachingEnabled]`.
...
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setFilesReadOnly(boolean)[setFilesReadOnly]`.

To enable the maximum number of entries that can be cached in memory at any one time you can use
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setMaxCacheSize(int)[setMaxCacheSize]`.

To configure the expiry time of cache entries you can use `link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setCacheEntryTimeout(long)[setCacheEntryTimeout]`.
...
This can be configured with `link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setIndexPage(java.lang.String)[setIndexPage]`.

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setWebRoot(java.lang.String)[setWebRoot]`.

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with `link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setIncludeHidden(boolean)[setIncludeHidden]`.

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setDirectoryListing(boolean)[setDirectoryListing]`.
...
`link:../../scaladocs/io/vertx/scala/ext/web/handler/StaticHandler.html#setDirectoryTemplate(java.lang.String)[setDirectoryTemplate]`.
...
`link:../../scaladocs/io/vertx/scala/ext/web/templ/TemplateEngine.html#render(io.vertx.ext.web.RoutingContext,%20java.lang.String,%20io.vertx.core.Handler)[render]` is used.
...
`io.vertx:vertx-web-templ-mvel:3.4.2-SNAPSHOT`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.4.2-SNAPSHOT`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.4.2-SNAPSHOT`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.4.2-SNAPSHOT`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:3.4.2-SNAPSHOT`. Create an instance of the Apache FreeMarker template engine
...
You should create one handler per SockJS application using `link:../../scaladocs/io/vertx/scala/ext/web/handler/sockjs/SockJSHandler.html#create(io.vertx.core.Vertx)[SockJSHandler.create]`.
...
`link:../../scaladocs/io/vertx/scala/ext/web/handler/sockjs/SockJSHandler.html#bridge(io.vertx.ext.web.handler.sockjs.BridgeOptions)[bridge]` on the
SockJS handler.
...
[source,groovy,subs="+attributes"]
----
compile 'io.vertx:vertx-web-scala_2.12:3.4.2-SNAPSHOT:client'
----
...
`link:../../scaladocs/io/vertx/scala/ext/web/handler/sockjs/SockJSHandler.html#bridge(io.vertx.ext.web.handler.sockjs.BridgeOptions,%20io.vertx.core.Handler)[bridge]`.
...
The event enables you to retrieve the type using `link:../../scaladocs/io/vertx/scala/ext/web/handler/sockjs/BridgeEvent.html#type()[type]` and
inspect the raw message of the event using `link:../../scaladocs/io/vertx/scala/ext/web/handler/sockjs/BridgeEvent.html#getRawMessage()[getRawMessage]`.
