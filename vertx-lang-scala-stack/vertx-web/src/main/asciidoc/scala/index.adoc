...
----
dependencies {
  compile 'io.vertx:vertx-web-scala_2.12:3.6.0-SNAPSHOT'
}
----
...
`io.vertx:vertx-web-templ-mvel:3.6.0-SNAPSHOT`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.6.0-SNAPSHOT`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.6.0-SNAPSHOT`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.6.0-SNAPSHOT`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:3.6.0-SNAPSHOT`. Create an instance of the Apache FreeMarker template engine
...
`io.vertx:vertx-web-templ-pebble:3.6.0-SNAPSHOT`. Create an instance of the Pebble template engine
...
[source,groovy,subs="+attributes"]
----
compile 'io.vertx:vertx-web-scala_2.12:3.6.0-SNAPSHOT:client'
----
...
`link:../../vertx-bridge-common/dataobjects.html#PermittedOptions#setRequiredAuthority(java.lang.String)[requiredAuthority]` field.
