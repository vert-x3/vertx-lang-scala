...
class LanguageHeader(private val _asJava: Object) extends Locale (_asJava) with ParsedHeaderValue {
   ...
   * <a href="https://tools.ietf.org/html/rfc7231#section-5.3.1">rfc7231</a>   * @return 
   */
   ...
   * </ol>
   * <b>Note:</b> The <code>q</code> parameter is never present.   * @return 
   */
   ...
   * <b>Note:</b> The <code>q</code> parameter is never present.   * @return Unmodifiable Map of parameters of this header value
   */
   ...
   * + info: <a href="https://tools.ietf.org/html/rfc7231#section-3.1.3.1">rfc7231#section-3.1.3.1</a>   * @return The language subtag at specified position
   */
