...
class TemplateHandler(private val _asJava: Object) extends io.vertx.core.Handler[RoutingContext] {
  def asJava = _asJava



  /**
   * Set the index template   * @param indexTemplate the index template
