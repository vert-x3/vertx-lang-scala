...
----
libraryDependencies += "io.vertx" %% "vertx-mysql-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-mysql-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-mysql-client-scala_2.13:4.0.0-SNAPSHOT"
----