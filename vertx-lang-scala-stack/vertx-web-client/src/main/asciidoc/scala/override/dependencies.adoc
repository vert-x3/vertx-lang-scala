...
----
libraryDependencies += "io.vertx" %% "vertx-web-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-web-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-web-client-scala_2.13:4.0.0-SNAPSHOT"
----