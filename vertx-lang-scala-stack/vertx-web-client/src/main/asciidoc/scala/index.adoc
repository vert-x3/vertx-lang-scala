...
// Send a GET request
client.get(8080, "myserver.mycompany.com", "/some-uri").send().onSuccess((response: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${response.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})

// Send a HEAD request
client.head(8080, "myserver.mycompany.com", "/some-uri").send().onSuccess((response: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${response.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").addQueryParam("param", "param_value").send().onSuccess((response: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${response.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
client.post(8080, "myserver.mycompany.com", "/some-uri").sendBuffer(buffer).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
client.post(8080, "myserver.mycompany.com", "/some-uri").sendStream(stream).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
fs.openFuture("content.txt", OpenOptions()).onComplete{
  case Success(result) => {
    ...
    client.post(8080, "myserver.mycompany.com", "/some-uri").putHeader("content-length", fileLen).sendStream(fileStream).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
      // OK
    })
  }
...
[source,scala]
----
client.post(8080, "myserver.mycompany.com", "/some-uri").sendJsonObject(new io.vertx.core.json.JsonObject().put("firstName", "Dale").put("lastName", "Cooper")).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
[source,scala]
----
client.post(8080, "myserver.mycompany.com", "/some-uri").sendJson(new examples.WebClientExamples.User("Dale", "Cooper")).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
client.post(8080, "myserver.mycompany.com", "/some-uri").sendForm(form).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
client.post(8080, "myserver.mycompany.com", "/some-uri").putHeader("content-type", "multipart/form-data").sendForm(form).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
// Submit the form as a multipart form body
client.post(8080, "myserver.mycompany.com", "/some-uri").sendMultipartForm(form).onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
get.send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
get.copy().putHeader("a-header", "with-some-value").send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").timeout(5000).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // OK
}).onFailure((err: java.lang.Throwable) => {
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").as(BodyCodec.jsonObject()).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.json.JsonObject>) => {
  var body = res.body()

  println(s"Received response with status code${res.statusCode()} with body ${body}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").as(BodyCodec.json(examples.WebClientExamples.User.class)).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<examples.WebClientExamples.User>) => {
  var user = res.body()

  println(s"Received response with status code${res.statusCode()} with body ${user.getFirstName()} ${user.getLastName()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").as(BodyCodec.pipe(writeStream)).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<java.lang.Void>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
client.get(8080, "myserver.mycompany.com", "/some-uri").as(BodyCodec.jsonStream(parser)).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<java.lang.Void>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").as(BodyCodec.none()).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<java.lang.Void>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
----
client.get(8080, "myserver.mycompany.com", "/some-uri").send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  if (res.statusCode() == 200 && res.getHeader("content-type") == "application/json") {
    // Decode the body as a json object
    var body = res.bodyAsJsonObject()

    println(s"Received response with status code${res.statusCode()} with body ${body}")
  } else {
    println(s"Something went wrong ${res.statusCode()}")
  }
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").expect(ResponsePredicate.SC_SUCCESS).expect(ResponsePredicate.JSON).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").expect(ResponsePredicate.status(200, 202)).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // ....
})
...
[source,scala]
----
client.get(8080, "myserver.mycompany.com", "/some-uri").expect(ResponsePredicate.contentType("some/content-type")).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  // ....
})
...
client.get(443, "myserver.mycompany.com", "/some-uri").ssl(true).send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
...
client.getAbs("https://myserver.mycompany.com:4043/some-uri").send().onSuccess((res: io.vertx.scala.ext.web.client.HttpResponse<io.vertx.scala.core.buffer.Buffer>) => {
  println(s"Received response with status code${res.statusCode()}")
}).onFailure((err: java.lang.Throwable) => {
  println(s"Something went wrong ${err.getMessage()}")
})
