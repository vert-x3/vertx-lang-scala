...
----
libraryDependencies += "io.vertx" %% "vertx-auth-ldap" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-ldap-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-ldap-scala_2.13:4.0.0-SNAPSHOT"
----