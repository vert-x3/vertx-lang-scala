...
[source,scala]
----
import io.vertx.scala.ext.stomp.StompServerHandler
import io.vertx.scala.ext.stomp.StompServer
...
You can configure the port and host in the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompServer.html#listen(int,%20java.lang.String)[listen]`
method:
...
The handler receive a reference on the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompServer.html[StompServer]`.
...
`link:../../scaladoc/io/vertx/scala/core/net/NetServer.html[NetServer]`, so you can configure the underlying `link:../../scaladoc/io/vertx/scala/core/net/NetServer.html[NetServer]` from
the `link:../dataobjects.html#StompServerOptions[StompServerOptions]`. Alternatively you can also pass the
`link:../../scaladoc/io/vertx/scala/core/net/NetServer.html[NetServer]` you want to use:
...
import io.vertx.scala.ext.stomp.StompServer
var server = StompServer.create(vertx, StompServerOptions()
  .setHeartbeat(todo-renderJsonObject)
).handler(StompServerHandler.create(vertx)).listen()

----

Enabling security requires an additional `link:../../scaladoc/io/vertx/scala/ext/auth/AuthProvider.html[AuthProvider]` handling the
...
More information about `link:../../scaladoc/io/vertx/scala/ext/auth/AuthProvider.html[AuthProvider]` is available
...
----
import io.vertx.scala.ext.stomp.StompServerHandler
import io.vertx.scala.ext.stomp.Destination
import io.vertx.scala.ext.stomp.StompServer
...
you can implement your own type of destination by providing a `link:../../scaladoc/io/vertx/scala/ext/stomp/DestinationFactory.html[DestinationFactory]`
returning your own `link:../../scaladoc/io/vertx/scala/ext/stomp/Destination.html[Destination]` object.

=== Acknowledgment

By default, the STOMP server does nothing when a message is not acknowledged. You can customize this by
providing your own `link:../../scaladoc/io/vertx/scala/ext/stomp/Destination.html[Destination]` implementation.

The custom destination should call the

`link:../../scaladoc/io/vertx/scala/ext/stomp/StompServerHandler.html#onAck(io.vertx.ext.stomp.StompServerConnection,%20io.vertx.ext.stomp.Frame,%20java.util.List)[onAck]`
and
`link:../../scaladoc/io/vertx/scala/ext/stomp/StompServerHandler.html#onNack(io.vertx.ext.stomp.StompServerConnection,%20io.vertx.ext.stomp.Frame,%20java.util.List)[onNack]`
method in order to let the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompServerHandler.html[StompServerHandler]` customizes the behavior:
...
You create a `link:../../scaladoc/io/vertx/scala/ext/stomp/StompClient.html[StompClient]` instance with default options as follows:

[source,scala]
----
import io.vertx.scala.ext.stomp.StompClient
...
`link:../../scaladoc/io/vertx/scala/ext/stomp/StompClientConnection.html[StompClientConnection]` that let you interact with the server. You can
...
use the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompClientConnection.html#disconnect()[disconnect]` method:
...
On the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompClientConnection.html[StompClientConnection]`, you can register an error handler receiving `ERROR`
...
`link:../../scaladoc/io/vertx/scala/ext/stomp/StompClientConnection.html#connectionDroppedHandler(io.vertx.core.Handler)[connectionDroppedHandler]`. The handler can
...
`link:../dataobjects.html#StompClientOptions[StompClientOptions]` when creating the `link:../../scaladoc/io/vertx/scala/ext/stomp/StompClient.html[StompClient]`. As the
STOMP client relies on a `link:../../scaladoc/io/vertx/scala/core/net/NetClient.html[NetClient]`, you can configure the underlying Net Client from
the `link:../dataobjects.html#StompClientOptions[StompClientOptions]`. Alternatively, you can pass the `link:../../scaladoc/io/vertx/scala/core/net/NetClient.html[NetClient]`
you want to use in the
`link:../../scaladoc/io/vertx/scala/ext/stomp/StompClient.html#connect(io.vertx.core.net.NetClient,%20io.vertx.core.Handler)[connect]` method:
...
`link:../../scaladoc/io/vertx/scala/ext/stomp/StompServer.html#webSocketHandler()[webSocketHandler]` result to
`link:../../scaladoc/io/vertx/scala/core/http/HttpServer.html#websocketHandler(io.vertx.core.Handler)[websocketHandler]`:
