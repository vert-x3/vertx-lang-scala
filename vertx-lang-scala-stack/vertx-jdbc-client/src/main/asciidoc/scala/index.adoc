...
<dependency>
  ...
  <artifactId>vertx-jdbc-client-scala_2.12</artifactId>
...
----
compile 'io.vertx:vertx-jdbc-client-scala_2.12:3.4.1-SNAPSHOT'
----
...
The first call to `link:../../scaladocs/io/vertx/scala/ext/jdbc/JDBCClient.html#createShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject)[JDBCClient.createShared]`
...
In that case you can use `link:../../scaladocs/io/vertx/scala/ext/jdbc/JDBCClient.html#createNonShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject)[JDBCClient.createNonShared]`.
...
This is equivalent to calling `link:../../scaladocs/io/vertx/scala/ext/jdbc/JDBCClient.html#createShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject,%20java.lang.String)[JDBCClient.createShared]`
...
Once you've created a client you use `link:../../scaladocs/io/vertx/scala/ext/jdbc/JDBCClient.html#getConnection(io.vertx.core.Handler)[getConnection]` to get
a connection.
