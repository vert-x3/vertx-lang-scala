...
----
compile 'io.vertx:vertx-jdbc-client-scala_2.12:3.4.2'
----
...
Once you've created a client you use `link:../../scaladocs/io/vertx/scala/ext/sql/SQLClient.html#getConnection(io.vertx.core.Handler)[getConnection]` to get
a connection.
