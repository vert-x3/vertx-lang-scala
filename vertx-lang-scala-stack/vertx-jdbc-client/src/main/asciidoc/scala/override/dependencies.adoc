...
----
libraryDependencies += "io.vertx" %% "vertx-jdbc-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-jdbc-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-jdbc-client-scala_2.13:4.0.0-SNAPSHOT"
----