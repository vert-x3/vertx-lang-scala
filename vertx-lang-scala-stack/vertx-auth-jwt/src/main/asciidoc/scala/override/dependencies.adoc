...
----
libraryDependencies += "io.vertx" %% "vertx-auth-jwt" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-jwt-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-jwt-scala_2.13:4.0.0-SNAPSHOT"
----