...
----
libraryDependencies += "io.vertx" %% "vertx-web-common" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-web-common-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-web-common-scala_2.13:4.0.0-SNAPSHOT"
----