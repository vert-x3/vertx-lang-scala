...
----
libraryDependencies += "io.vertx" %% "vertx-mqtt" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-mqtt-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-mqtt-scala_2.13:4.0.0-SNAPSHOT"
----