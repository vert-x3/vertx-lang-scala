...
If you want to disable this feature then you should call `link:../dataobjects.html#MqttClientOptions#setAutoKeepAlive(boolean)[autoKeepAlive]` with {@code false} as argument:
[source,scala]
----
