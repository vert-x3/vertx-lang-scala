...
----
libraryDependencies += "io.vertx" %% "vertx-auth-jdbc" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-jdbc-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-jdbc-scala_2.13:4.0.0-SNAPSHOT"
----