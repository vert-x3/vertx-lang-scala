...
with the operations `link:../../scaladocs/io/vertx/scala/ext/auth/jdbc/JDBCAuth.html#setAuthenticationQuery()[setAuthenticationQuery]`,
`link:../../scaladocs/io/vertx/scala/ext/auth/jdbc/JDBCAuth.html#setPermissionsQuery()[setPermissionsQuery]` and
`link:../../scaladocs/io/vertx/scala/ext/auth/jdbc/JDBCAuth.html#setRolesQuery()[setRolesQuery]`, if you want to use them with a different
database schema.
...
`link:../../scaladocs/io/vertx/scala/ext/auth/jdbc/JDBCAuth.html#setHashStrategy()[setHashStrategy]`.
...
The default role prefix is `role:`. You can change this with `link:../../scaladocs/io/vertx/scala/ext/auth/jdbc/JDBCAuth.html#setRolePrefix()[setRolePrefix]`.
