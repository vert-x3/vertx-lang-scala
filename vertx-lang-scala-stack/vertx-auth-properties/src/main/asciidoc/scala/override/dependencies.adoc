...
----
libraryDependencies += "io.vertx" %% "vertx-auth-properties" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-properties-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-properties-scala_2.13:4.0.0-SNAPSHOT"
----