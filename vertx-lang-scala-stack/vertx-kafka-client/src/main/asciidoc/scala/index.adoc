...
topic, avoiding to register the handler for getting the messages and then using the `link:../../scaladocs/io/vertx/scala/kafka/client/consumer/KafkaConsumer.html#poll(long,%20io.vertx.core.Handler)[poll]` method.
