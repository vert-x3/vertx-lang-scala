...
----
libraryDependencies += "io.vertx" %% "vertx-kafka-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-kafka-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-kafka-client-scala_2.13:4.0.0-SNAPSHOT"
----