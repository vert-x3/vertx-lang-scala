...
----
libraryDependencies += "io.vertx" %% "vertx-shell" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-shell-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-shell-scala_2.13:4.0.0-SNAPSHOT"
----