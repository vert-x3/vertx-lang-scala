...
----
libraryDependencies += "io.vertx" %% "vertx-dropwizard-metrics" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-dropwizard-metrics-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-dropwizard-metrics-scala_2.13:4.0.0-SNAPSHOT"
----