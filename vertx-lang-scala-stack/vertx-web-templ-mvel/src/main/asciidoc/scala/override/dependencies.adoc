...
----
libraryDependencies += "io.vertx" %% "vertx-web-templ-mvel" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-web-templ-mvel-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-web-templ-mvel-scala_2.13:4.0.0-SNAPSHOT"
----