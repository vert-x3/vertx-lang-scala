...
The client API is represented with the interface `link:../../scaladoc/io/vertx/scala/ext/jdbc/JDBCClient.html[JDBCClient]`.
...
[source,java]
----
`exampleCreateDefault`
----

The first call to `link:../../scaladoc/io/vertx/scala/ext/jdbc/JDBCClient.html#createShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject)[JDBCClient.createShared]`
...
In that case you can use `link:../../scaladoc/io/vertx/scala/ext/jdbc/JDBCClient.html#createNonShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject)[JDBCClient.createNonShared]`.

[source,java]
----
`exampleCreateNonShared`
----

This is equivalent to calling `link:../../scaladoc/io/vertx/scala/ext/jdbc/JDBCClient.html#createShared(io.vertx.core.Vertx,%20io.vertx.core.json.JsonObject,%20java.lang.String)[JDBCClient.createShared]`
...
Once you've created a client you use `link:../../scaladoc/io/vertx/scala/ext/jdbc/JDBCClient.html#getConnection(io.vertx.core.Handler)[getConnection]` to get
a connection.
...
The connection is an instance of `link:../../scaladoc/io/vertx/scala/ext/sql/SQLConnection.html[SQLConnection]` which is a common interface not only used by
