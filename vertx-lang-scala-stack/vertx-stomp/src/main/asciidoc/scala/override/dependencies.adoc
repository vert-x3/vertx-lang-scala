...
----
libraryDependencies += "io.vertx" %% "vertx-stomp" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-stomp-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-stomp-scala_2.13:4.0.0-SNAPSHOT"
----