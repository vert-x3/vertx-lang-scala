...
class StompServerHandler(private val _asJava: Object) extends io.vertx.core.Handler[ServerFrame] {
  def asJava = _asJava
   ...
   * This handler can be used for logging, debugging or ad-hoc behavior.   * @param handler the handler
   ...
   * using [[io.vertx.scala.ext.stomp.StompServerHandler#authProvider]].   * @param connection server connection that contains session ID
   ...
   * Implementations must call the handler configured using [[io.vertx.scala.ext.stomp.StompServerHandler#onAckHandler]].   * @param connection the connection
   ...
   * [[io.vertx.scala.ext.stomp.StompServerHandler#onNackHandler]].   * @param connection the connection
   * @param subscribe the `SUBSCRIBE` frame see <a href="../../../../../../../cheatsheet/Frame.html">Frame</a>
   * @param messages the acknowledge messages
   * @return the current StompServerHandler
   */
  ...
  /**
   * Configures the action to execute when messages are <strong>not</strong> acknowledged.   * @param handler the handler
   * @return the current StompServerHandler
   */
  ...
  /**
   * Configures the STOMP server to act as a bridge with the Vert.x event bus.   * @param options the configuration options see <a href="../../../../../../../cheatsheet/BridgeOptions.html">BridgeOptions</a>
   * @return the current StompServerHandler.
   */
   ...
   * [[io.vertx.scala.ext.stomp.StompServerHandler#closeHandler]] if any.   * @param connection the connection
   */
   ...
   * [[io.vertx.scala.ext.stomp.DestinationFactory]].   * @param destination the destination
