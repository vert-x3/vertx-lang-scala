...
class Destination(private val _asJava: Object) {
   ...
   * @param frame the `SUBSCRIBE` frame see <a href="../../../../../../../cheatsheet/Frame.html">Frame</a>
   * @return the current instance of Destination
   */
   ...
   * @param frame the `UNSUBSCRIBE` frame see <a href="../../../../../../../cheatsheet/Frame.html">Frame</a>
   ...
   * @param frame the `ACK` frame see <a href="../../../../../../../cheatsheet/Frame.html">Frame</a>
   ...
   * @param frame the `NACK` frame see <a href="../../../../../../../cheatsheet/Frame.html">Frame</a>
   * @return `true` if the destination has handled the frame (meaning it has sent the message with id)
   */
