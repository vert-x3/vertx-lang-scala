...
----
libraryDependencies += "io.vertx" %% "vertx-auth-htpasswd" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-auth-htpasswd-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-auth-htpasswd-scala_2.13:4.0.0-SNAPSHOT"
----