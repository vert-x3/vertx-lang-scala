...
----
libraryDependencies += "io.vertx" %% "vertx-mssql-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-mssql-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-mssql-client-scala_2.13:4.0.0-SNAPSHOT"
----