...
----
libraryDependencies += "io.vertx" %% "vertx-redis-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-redis-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-redis-client-scala_2.13:4.0.0-SNAPSHOT"
----