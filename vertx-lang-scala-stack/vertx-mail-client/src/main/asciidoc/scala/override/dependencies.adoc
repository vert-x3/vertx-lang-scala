...
----
libraryDependencies += "io.vertx" %% "vertx-mail-client" % "4.0.0-SNAPSHOT"
----
...
<dependency>
  ...
  <artifactId>vertx-mail-client-scala_2.13</artifactId>
...
----
compile "io.vertx:vertx-mail-client-scala_2.13:4.0.0-SNAPSHOT"
----