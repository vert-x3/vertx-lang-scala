...
`link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#getNow(io.vertx.core.http.RequestOptions,%20io.vertx.core.Handler)[getNow]`.
...
general purpose request methods such as `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#request(io.vertx.core.http.HttpMethod,%20io.vertx.core.http.RequestOptions)[request]` which allow you to specify
...
To do this you can call one of the specific request methods such as `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#post(io.vertx.core.http.RequestOptions)[post]` or
one of the general purpose request methods such as `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#request(io.vertx.core.http.HttpMethod,%20io.vertx.core.http.RequestOptions)[request]`.
...
The policy handles the original `link:../../scaladoc/io/vertx/scala/core/http/HttpClientResponse.html[HttpClientResponse]` received and returns either `null`
...
* request headers, unless if you have set some headers (including `link:../../scaladoc/io/vertx/scala/core/http/HttpClientRequest.html#setHost(java.lang.String)[setHost]`)
...
specifying a scheme with `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#requestAbs(io.vertx.core.http.HttpMethod,%20java.lang.String)[requestAbs]`
method.
...
Likewise `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#requestAbs(io.vertx.core.http.HttpMethod,%20java.lang.String)[requestAbs]` scheme
...
You can connect a WebSocket to a server using one of the `link:../../scaladoc/io/vertx/scala/core/http/HttpClient.html#websocket(io.vertx.core.http.RequestOptions,%20io.vertx.core.Handler)[websocket]` operations and
providing a handler.
...
`link:../../scaladoc/io/vertx/scala/core/http/WebSocket.html#writeBinaryMessage(io.vertx.core.buffer.Buffer)[writeBinaryMessage]` or
`link:../../scaladoc/io/vertx/scala/core/http/WebSocket.html#writeTextMessage(java.lang.String)[writeTextMessage]` :
