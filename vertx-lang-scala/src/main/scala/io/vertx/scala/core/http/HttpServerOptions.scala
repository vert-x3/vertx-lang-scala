...
class HttpServerOptions(private val _asJava: JHttpServerOptions) extends ExtNetServerOptions(_asJava) {
   ...
   *
   * If you want change default time unit, use <a href="../../../../../../../cheatsheet/HttpServerOptions.html">HttpServerOptions</a>
   */
