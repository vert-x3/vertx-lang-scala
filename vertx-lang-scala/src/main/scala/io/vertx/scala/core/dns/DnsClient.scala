...
class DnsClient(private val _asJava: JDnsClient) {
  ...
  /**
    ...
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with the resolved address if a record was found. If non was found it will get notifed with `null`. If an error accours it will get failed.
    */
  ...
  /**
    ...
    * @param name the name to resolve
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with the resolved java.net.Inet4Address if a record was found. If non was found it will get notifed with `null`. If an error accours it will get failed.
    */
  ...
  /**
    ...
    * @param name the name to resolve
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with the resolved java.net.Inet6Address if a record was found. If non was found it will get notifed with `null`. If an error accours it will get failed.
    */
  ...
  /**
    ...
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with the resolved String if a record was found. If none was found it will get notified with `null`. If an error accours it will get failed.
    */
  ...
  /**
    ...
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with a List that contains all resolved Strings. If none was found it will get notified with an empty scala.collection.immutable.List. If an error accours it will get failed.
    */
  ...
  /**
    ...
    * @return the scala-function to notify with the io.vertx.lang.scala.AsyncResult. The future will get notified with a List that contains all resolved SrvRecords. If none was found it will get notified with an empty scala.collection.immutable.List. If an error accours it will get failed.
    */
