...
class HttpClientOptions(private val _asJava: JHttpClientOptions) extends ExtClientOptionsBase(_asJava) {
  def asJava = _asJava
  /**
   ...
   *
   * If you want change default time unit, use <a href="../../../../../../../cheatsheet/HttpClientOptions.html">HttpClientOptions</a>
   */
   ...
   */
  def setPoolCleanerPeriod(value: Int) = {
