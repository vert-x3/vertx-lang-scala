...
class CommandLine(private val _asJava: Object) {
  ...
  /**
   * Gets the raw values of the given option. Raw values are simple "String", not converted to the option type.   * @param option the option see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
  ...
  /**
   * Checks whether or not the given option has been assigned in the command line.   * @param option the option see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
  ...
  /**
   * Gets the raw values of the given argument. Raw values are simple "String", not converted to the argument type.   * @param argument the argument see <a href="../../../../../../../cheatsheet/Argument.html">Argument</a>
   * @return the list of values, empty if none
   */
  ...
  /**
   * Gets the raw value of the given option. Raw values are the values as given in the user command line.   * @param option the option see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
  ...
  /**
   * Checks whether or not the given option accept more values.   * @param option the option see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
  ...
  /**
   * Gets the raw value of the given argument. Raw values are the values as given in the user command line.   * @param arg the argument see <a href="../../../../../../../cheatsheet/Argument.html">Argument</a>
   * @return the value, `null` if none.
   */
  ...
  /**
   * Checks whether or not the given argument has been assigned in the command line.   * @param arg the argument see <a href="../../../../../../../cheatsheet/Argument.html">Argument</a>
  ...
  /**
   * Checks whether or not the given option has been seen in the user command line.   * @param option the option see <a href="../../../../../../../cheatsheet/Option.html">Option</a>
   ...
   * satisfied. This method is used when the parser validation is disabled.   * @return `true` if the current CommandLine object is valid. false otherwise.
   */
  def isValid (): Boolean = {
