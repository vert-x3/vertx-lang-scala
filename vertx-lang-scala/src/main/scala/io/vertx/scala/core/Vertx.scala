...
/**
  ...
  * 
  * To create an instance of this class you can use the static factory methods: [[io.vertx.scala.core.Vertx$.vertx():io.vertx.scala.core.Vertx]],
  * [[io.vertx.scala.core.Vertx$.vertx(options:io.vertx.scala.core.VertxOptions):io.vertx.scala.core.Vertx]] and [[io.vertx.scala.core.Vertx$.clusteredVertx(options:io.vertx.scala.core.VertxOptions,resultHandler:io.vertx.lang.scala.AsyncResult):Unit]].
  * 
...
class Vertx(private val _asJava: JVertx) 
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.close():Unit]] but the completionHandler will be called when the close is complete
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.deployVerticle(name:String):Unit]] but the completionHandler will be notified when the deployment is complete.
    * 
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.deployVerticle(verticle:io.vertx.scala.core.Verticle):Unit]] but <a href="../../../../../../cheatsheet/DeploymentOptions.html">DeploymentOptions</a> are provided to configure the
    * deployment.
    * @param name the name
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.deployVerticle(name:String,completionHandler:io.vertx.lang.scala.AsyncResult):Unit]] but <a href="../../../../../../cheatsheet/DeploymentOptions.html">DeploymentOptions</a> are provided to configure the
    * deployment.
    * @param name the name
    * @param options the deployment options.see <a href="../../../../../../cheatsheet/DeploymentOptions.html">DeploymentOptions</a>
    * @return a future which will be notified when the deployment is complete
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.executeBlocking(blockingCodeHandler:io.vertx.scala.core.Handler[io.vertx.scala.core.Future[T]],ordered:Boolean,resultHandler:io.vertx.lang.scala.AsyncResult):Unit]] called with ordered = true.
WARNING: THIS METHOD NEEDS BETTER DOCUMENTATION THAT ADHERES TO OUR CONVENTIONS. THIS ONE LACKS A PARAM-TAG FOR THE HANDLER    */
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.createSharedWorkerExecutor(name:String,poolSize:Int):io.vertx.scala.core.WorkerExecutor]] but with the <a href="../../../../../../cheatsheet/VertxOptions.html">VertxOptions</a> `poolSize`.
    */
  ...
  /**
    * Like [[io.vertx.scala.core.Vertx!.createSharedWorkerExecutor(name:String,poolSize:Int,maxExecuteTime:Long):io.vertx.scala.core.WorkerExecutor]] but with the <a href="../../../../../../cheatsheet/VertxOptions.html">VertxOptions</a> `maxExecuteTime`.
    */
