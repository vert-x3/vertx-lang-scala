...
/**
  ...
  * is released.
  */
class Lock(private val _asJava: Object, private val _useTypeTags:Boolean = false) {
...
//future methods
  ...
  object Lock{
    def apply(asJava: Object, useTypeTags:Boolean = false) = new Lock(asJava, useTypeTags)  
  //static methods
  }
