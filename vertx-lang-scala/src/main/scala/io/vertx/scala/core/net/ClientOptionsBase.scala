...
trait ClientOptionsBase extends ExtTCPSSLOptions {
   ...
   *
   * If you want change default time unit, use <a href="../../../../../../../cheatsheet/ClientOptionsBase.html">ClientOptionsBase</a>
   */
   ...
   */
  def setIdleTimeoutUnit(value: java.util.concurrent.TimeUnit): ClientOptionsBase
