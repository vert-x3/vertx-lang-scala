...
class SelfSignedCertificate(private val _asJava: Object) {
  ...
  /**
   * Provides the [[io.vertx.scala.core.net.KeyCertOptions]] RSA private key file in PEM format corresponding to the [[io.vertx.scala.core.net.SelfSignedCertificate#privateKeyPath]]   * @return a PemKeyCertOptions based on the generated certificate.see <a href="../../../../../../../cheatsheet/PemKeyCertOptions.html">PemKeyCertOptions</a>
   */
  ...
  /**
   * Provides the [[io.vertx.scala.core.net.TrustOptions]] X.509 certificate file in PEM format corresponding to the [[io.vertx.scala.core.net.SelfSignedCertificate#certificatePath]]   * @return a PemTrustOptions based on the generated certificate.see <a href="../../../../../../../cheatsheet/PemTrustOptions.html">PemTrustOptions</a>
   */
