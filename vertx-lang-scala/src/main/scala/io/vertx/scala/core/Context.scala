...
/**
  ...
  * as single threaded.
  * 
  * This class also allows arbitrary data to be [[io.vertx.scala.core.Context!.put(String,AnyRef):Unit]] and [[io.vertx.scala.core.Context!.get(String):T]] on the context so it can be shared easily
  * amongst different handlers of, for example, a verticle instance.
  * 
  * This class also provides [[io.vertx.scala.core.Context!.runOnContext(io.vertx.scala.core.Handler[Void]):Unit]] which allows an action to be executed asynchronously using the same context.
  */
class Context(private val _asJava: JContext) {
  ...
  /**
    * Invoke [[io.vertx.scala.core.Context!.executeBlocking(io.vertx.scala.core.Handler[io.vertx.scala.core.Future[T]],Boolean,io.vertx.lang.scala.AsyncResult):Unit]] with order = true.
    * @param blockingCodeHandler handler representing the blocking code to run
    * @return future that will be called when the blocking code is complete
    */
  ...
  /**
    ...
    * 
    * NOTE! when running blocking code using [[io.vertx.scala.core.Vertx!.executeBlocking(io.vertx.scala.core.Handler[io.vertx.scala.core.Future[T]],io.vertx.lang.scala.AsyncResult):Unit]] from a
