...
class HttpClientResponse(private val _asJava: Object) extends ReadStream[io.vertx.core.buffer.Buffer] {
  def asJava = _asJava
   ...
   * remote peer and it responded with a status code of 200.   * @return the net socket
   */
