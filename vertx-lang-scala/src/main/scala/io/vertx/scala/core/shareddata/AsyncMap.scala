...
class AsyncMap[K, V](private val _asJava: JAsyncMap[K, V]) {
  ...
  /**
    * Like [[io.vertx.scala.core.shareddata.AsyncMap!.put(k:K,v:V,completionHandler:io.vertx.lang.scala.AsyncResult):Unit]] but specifying a time to live for the entry. Entry will expire and get evicted after the
    * ttl.
    * @param k the key
    * @param v the value
  ...
  /**
    * Link [[io.vertx.scala.core.shareddata.AsyncMap!.putIfAbsent(k:K,v:V,completionHandler:io.vertx.lang.scala.AsyncResult):Unit]] but specifying a time to live for the entry. Entry will expire and get evicted
    * after the ttl.
    * @param k the key
    * @param v the value
    * @param ttl The time to live (in ms) for the entry
