...
/**
  ...
  *   <li>[[io.vertx.scala.core.http.HttpConnection!.closeHandler(io.vertx.scala.core.Handler[Void]):io.vertx.scala.core.http.HttpConnection]]</li>
  *   <li>[[io.vertx.scala.core.http.HttpConnection!.exceptionHandler(io.vertx.scala.core.Handler[Throwable]):io.vertx.scala.core.http.HttpConnection]]</li>
  * </ul>
  */
class HttpConnection(private val _asJava: JHttpConnection) {
  ...
  /**
    * Like [[io.vertx.scala.core.http.HttpConnection!.goAway(Long,Int):io.vertx.scala.core.http.HttpConnection]] with a last stream id `2^31-1`.
    */
  ...
  /**
    * Like [[io.vertx.scala.core.http.HttpConnection!.goAway(Long,Int,io.vertx.scala.core.buffer.Buffer):io.vertx.scala.core.http.HttpConnection]] with no buffer.
    */
