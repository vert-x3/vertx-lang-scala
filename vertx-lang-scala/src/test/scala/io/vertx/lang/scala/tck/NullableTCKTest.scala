...
class NullableTCKTest extends AnyFlatSpec with Matchers with OptionValues {
  ...
  val nullableTCK = new NullableTCKImpl
//
//  "testNullableByte" should "work" in {
//    val testByte: Byte = 67.asInstanceOf
//    nullableTCK.methodWithNullableByteParam(Boolean.box(true), None)
//    nullableTCK.methodWithNullableByteParam(Boolean.box(true), Option(testByte))
