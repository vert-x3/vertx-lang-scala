...
import io.vertx.scala.core.JsonArray

import java.lang.Boolean.FALSE

class ExtensionsSpec extends AnyFunSpec with Matchers with Inside {
  ...
  describe("json String interpolator") {
    it("should be able to construct an empty JsonObject") {
      json"{}" should equal(new JsonObject())
    }
