...
/**
  */
class InterfaceWithVariableArg[T,U](private val _asJava: Object) 
...
//basic methods
  ...
  object InterfaceWithVariableArg{
    def apply[T,U](asJava: JInterfaceWithVariableArg[T,U]) = new InterfaceWithVariableArg[T,U](asJava)  
  //static methods
  }
