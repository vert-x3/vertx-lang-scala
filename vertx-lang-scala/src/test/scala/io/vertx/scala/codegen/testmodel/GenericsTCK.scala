...
class GenericsTCK(private val _asJava: JGenericsTCK) {
  ...
  def methodWithHandlerClassTypeParameterized[U](`type`: java.lang.Class[U], handler: io.vertx.core.Handler[GenericRefedInterface[U]]): Unit = {
  ...
  def methodWithClassTypeHandler[U](`type`: java.lang.Class[U], f: io.vertx.core.Handler[U]): Unit = {
    _asJava.methodWithClassTypeHandler(`type`, (f))
  }
